...
jlongArray findMethodUsingString(
...
jlong load(JNIEnv *env, jobject thiz, jobject class_loader) {
  if (!class_loader)
    return 0;
...
jlongArray findMethodSettingField(
...
jlongArray findMethodGettingField(
    JNIEnv *env, jobject thiz, jlong field_index, jlong return_type,
    jshort parameter_count, jstring parameter_shorty, jlong declaring_class,
    jlongArray parameter_types, jlongArray contains_parameter_types,
    jintArray dex_priority, jboolean find_first) {
...
jlongArray findField(JNIEnv *env, jobject thiz,
                                                   jlong type,
...
jobject decodeMethodIndex(JNIEnv *env,
                                                           jobject thiz,
                                                           jlong method_index) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
jobject decodeFieldIndex(JNIEnv *env,
                                                          jobject thiz,
                                                          jlong field_index) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
jlong encodeClassIndex(JNIEnv *env,
                                                          jobject thiz,
                                                          jclass clazz) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
jlong encodeFieldIndex(JNIEnv *env,
                                                          jobject thiz,
                                                          jobject field) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
jlong encodeMethodIndex(JNIEnv *env,
                                                           jobject thiz,
                                                           jobject method) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
jclass decodeClassIndex(JNIEnv *env,
                                                          jobject thiz,
                                                          jlong class_index) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
void closex(JNIEnv *env, jobject thiz) {
  auto *handler =
      reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
void createFullCache(JNIEnv *env,
                            jobject thiz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
...
const JNINativeMethod methods[] = {
    {"findMethodUsingString",  "(Ljava/lang/String;ZJSLjava/lang/String;J[J[J[IZ)[J", (void*)findMethodUsingString},
    {"findMethodInvoking",     "(JJSLjava/lang/String;J[J[J[IZ)[J",                   (void*)findMethodInvoking},
    {"findMethodInvoked",      "(JJSLjava/lang/String;J[J[J[IZ)[J",                   (void*)findMethodInvoked},
    {"findMethodSettingField", "(JJSLjava/lang/String;J[J[J[IZ)[J",                   (void*)findMethodSettingField},
    {"findMethodGettingField", "(JJSLjava/lang/String;J[J[J[IZ)[J",                   (void*)findMethodGettingField},
    {"findField",              "(J[IZ)[J",                                            (void*)findField},
    {"decodeClassIndex",       "(J)Ljava/lang/Class;",                                (void*)decodeClassIndex},
    {"decodeMethodIndex",      "(J)Ljava/lang/reflect/Executable;",                       (void*)decodeMethodIndex},
    {"decodeFieldIndex",       "(J)Ljava/lang/reflect/Field;",                        (void*)decodeFieldIndex},
    {"encodeClassIndex",       "(Ljava/lang/Class;)J",                                (void*)encodeClassIndex},
    {"encodeMethodIndex",      "(Ljava/lang/reflect/Executable;)J",                       (void*)encodeMethodIndex},
    {"encodeFieldIndex",       "(Ljava/lang/reflect/Field;)J",                        (void*)encodeFieldIndex},
    {"load",                   "(Ljava/lang/ClassLoader;)J",                          (void*)load},
    {"close",                  "()V",                                                 (void*)closex},
    {"createFullCache",        "()V",                                                 (void*)createFullCache},
};
...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *) {
  ...
  jclass helper = env->FindClass("io/github/vvb2060/xposed/DexHelper");
